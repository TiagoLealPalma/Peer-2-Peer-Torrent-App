...
public class DownloadWorker extends Thread {
    ...
    public void run() {
        while(running){
            ...
            int currentIndex = downloadProcess.getNextIndex();
            ...
            if(currentIndex != -1) {
                ...
                } catch (InterruptedException e) { System.out.println("Worker (" + PROCESS_ID + ") interrupted");}
        ...
        //connection.send
        // Receber o indice
        // Pedir ao process pelo bloco correspondente a esse indice
        // Enviar esse bloco
    }


    // Called by the connection to submit the received block
    public void submitFileBlockResult(FileBlockResult fileBlockResult){
